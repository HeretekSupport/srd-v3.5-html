# D&D 3.5 SRD - Complete Feat Extraction

**Source:** D&D 3.5 SRD - Basic Rules and Legal
**HTML File:** feats.html
**Total Feats Extracted:** 111
...
- **Metamagic Feats:** 10
- **Special Feats:** 1
- **Fighter Bonus Feats:** 48
- **Feats Allowing Multiples:** 24
- **Feats Requiring Choices:** 6

---

## Complete Feat List with Details
...
### 5. Armor Proficiency (Heavy) [General]
...
### 6. Armor Proficiency (Light) [General]
- **Prerequisites:** None
...
### 7. Armor Proficiency (Medium) [General]
...
### 16. Craft Magic Arms and Armor [Item Creation]
...
### 20. Craft Wondrous Item [Item Creation]
- **Prerequisites:** Caster level 3rd
...
### 31. Exotic Weapon Proficiency [General]
...
- **Fighter Bonus Feat:** YES
- **Allows Multiples:** YES
- **Requires Choice:** No
- **Choice Description:** Choose a type of exotic weapon

### 32. Extend Spell [Metamagic]
- **Prerequisites:** None
...
### 38. Greater Spell Focus [General]
- **Prerequisites:** Spell Focus with chosen school
...
- **Allows Multiples:** YES
- **Requires Choice:** Yes
- **Choice Description:** Choose a school of magic to which you already have applied the Spell Focus feat

### 39. Greater Spell Penetration [General]
...
### 40. Greater Two-Weapon Fighting [General]
...
### 41. Greater Weapon Focus [General]
...
- **Allows Multiples:** YES
- **Requires Choice:** Yes
- **Choice Description:** Choose one type of weapon for which you have already selected Weapon Focus

### 42. Greater Weapon Specialization [General]
...
- **Allows Multiples:** YES
- **Requires Choice:** Yes
- **Choice Description:** Choose one type of weapon for which you have already selected Weapon Specialization

### 43. Heighten Spell [Metamagic]
- **Prerequisites:** None
...
### 45. Improved Counterspell [General]
- **Prerequisites:** None
...
- **Allows Multiples:** YES
- **Requires Choice:** Yes
- **Choice Description:** Choose one type of weapon

### 47. Improved Disarm [General]
...
### 51. Improved Initiative [General]
- **Prerequisites:** None
...
### 53. Improved Precise Shot [General]
...
### 54. Improved Shield Bash [General]
...
### 58. Improved Two-Weapon Fighting [General]
...
### 59. Improved Unarmed Strike [General]
- **Prerequisites:** None
...
### 62. Leadership [General]
- **Prerequisites:** Character level 6th
- **Benefit:** Having this feat enables the character to attract loyal companions and devoted followers, subordinates who assist her. See detailed rules for what sort of cohort and how many followers the character can recruit.
- **Fighter Bonus Feat:** No
- **Allows Multiples:** No
- **Requires Choice:** No

### 63. Lightning Reflexes [General]
- **Prerequisites:** None
...
### 66. Martial Weapon Proficiency [General]
- **Prerequisites:** None
...
- **Allows Multiples:** YES
- **Requires Choice:** Yes
- **Choice Description:** Choose a type of martial weapon

### 67. Maximize Spell [Metamagic]
- **Prerequisites:** None
...
- **Allows Multiples:** YES
- **Requires Choice:** Yes
- **Choice Description:** Choose a type of crossbow

### 81. Rapid Shot [General]
...
### 84. Scribe Scroll [Item Creation]
...
### 89. Simple Weapon Proficiency [General]
- **Prerequisites:** None
...
- **Allows Multiples:** YES
- **Requires Choice:** Yes
- **Choice Description:** Choose a skill

### 91. Snatch Arrows [General]
...
- **Allows Multiples:** YES
- **Requires Choice:** Yes
- **Choice Description:** Choose a school of magic

### 93. Spell Mastery [Special]
...
### 101. Tower Shield Proficiency [General]
- **Prerequisites:** Shield Proficiency
...
### 104. Two-Weapon Defense [General]
...
### 105. Two-Weapon Fighting [General]
...
### 108. Weapon Specialization [General]
...
- **Allows Multiples:** YES
- **Requires Choice:** Yes
- **Choice Description:** Choose one type of weapon for which you have already selected the Weapon Focus feat

### 109. Whirlwind Attack [General]
...
The following files have been generated from this extraction:

1. **feats_extracted.json** - Complete feat data in JSON format for easy import into databases
2. **feats_insert.sql** - SQL INSERT statements ready to populate a database
3. **FEATS_COMPREHENSIVE_LIST.md** - This comprehensive markdown document

All files are located in: `d:\Workspace\WEB\PROJECTS\`
...
### Using JSON
The `feats_extracted.json` file contains structured data that can be imported into most database systems. Each feat entry includes:
- name
- type
- prerequisites
- benefit
- normal
- special
- is_fighter_bonus (boolean)
- allows_multiples (boolean)
- requires_choice (boolean)
- choice_description

### Using SQL
The `feats_insert.sql` file contains ready-to-execute INSERT statements. You can run this directly in any SQL database that supports standard INSERT syntax.

---

## Notes

- One entry "Feat Name [Type of Feat]" was extracted but is actually a template/example entry from the documentation (entry #35), not an actual feat. This may need to be filtered out during import.
- Feat descriptions have been cleaned of HTML formatting and fully extracted from the source document.
- All prerequisite information, benefit text, normal text, and special text has been preserved and included.

---

**Extraction Date:** December 29, 2025
**Source:** D&D 3.5 SRD - feats.html
